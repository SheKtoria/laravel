...
<body>
<div id="app">
    <nav class="navbar navigation navbar-expand-md shadow-sm">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto ">
                    ...
                    @guest
                        @if (Route::has('login'))
                            <li class="nav-item">
                                <a class="nav-link pageref" href="{{ route('login') }}">{{ __('Login') }}</a>
                            </li>
                        @endif

                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav-link pageref" href="{{ route('register') }}">{{ __('Register') }}</a>
                            </li>
                        @endif
                    @else
